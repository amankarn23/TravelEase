...
function Header() {
  ...
  return (
    <div className="main_header makeFlex make-justify-center">
      <div className="header_second responsive-header makeFlex make-align-center make-justify-space gap-140 padding-t-5 padding-b-50">
        ...
        <div>
          <ul className="header-userLists makeFlex">
            ...
            >
              <div>
                <div className="whiteText makeFlexmakeCenter langSlct">
